...
function load_css()
{
    ...
    wp_register_style( 'main', get_template_directory_uri().'/css/main.css', array(), '1.0.6', 'all');
...
function load_js()
{
    ...
    wp_register_script( 'newrelic', get_template_directory_uri().'/js/newrelic.js', 'newrelic', '1.0.1', true);
